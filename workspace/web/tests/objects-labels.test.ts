...
describe("objects labels", () => {
  ...
  it("formats headings, version tags, and toggle labels", () => {
    ...
    expect(thresholdPermilleText(5)).toBe("0.50%");
    expect(thresholdPermilleText(12)).toBe("1.20%");
    expect(thresholdPermilleText(50)).toBe("5.00%");
    expect(thresholdPermilleText(1)).toBe("0.10%");
    expect(thresholdPermilleText(0)).toBe("0.00%");
    expect(thresholdPermilleText(0.1)).toBe("0.01%");
    expect(thresholdPermilleText(0.3)).toBe("0.03%");
    expect(thresholdPermilleText(0.9)).toBe("0.09%");
    expect(thresholdPermilleText(2.5)).toBe("0.25%");
  });
});
