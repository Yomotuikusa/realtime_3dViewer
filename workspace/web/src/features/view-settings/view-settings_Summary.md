...
- view-settings.ts: 10 個の設定キー、グループ、単位、既定値、範囲、順序、HUD／ダイアログ面の分類、値の clamp を定義する
...
- ViewSettingsMenu.tsx: HUD の「表示」メニュー内に表示系 4 グループ・8 スライダーと HUD 面全体リセットを表示する
...
- tests/view-settings-menu.test.ts: HUD の 4 グループ・8 行、値表示、変更状態、操作、HUD 面内全体 reset、専用 CSS のテスト
